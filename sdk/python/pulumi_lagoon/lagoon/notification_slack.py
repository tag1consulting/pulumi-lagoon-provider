...
class NotificationSlackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] channel: The Slack channel (e.g., '#deployments').
        :param pulumi.Input[_builtins.str] name: The notification name.
        :param pulumi.Input[_builtins.str] webhook: The Slack webhook URL (stored as secret).
        """
...
@pulumi.type_token("lagoon:lagoon:NotificationSlack")
class NotificationSlack(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NotificationSlack':
        """
