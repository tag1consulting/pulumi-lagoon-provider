...
namespace Tag1Consulting.Lagoon
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/tag1consulting/pulumi-lagoon-provider";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Tag1Consulting.Lagoon.version.txt");
    ...
    internal sealed class LagoonResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LagoonResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
