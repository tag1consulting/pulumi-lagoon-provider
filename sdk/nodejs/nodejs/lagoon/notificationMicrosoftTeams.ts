 ...
 */
export class NotificationMicrosoftTeams extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotificationMicrosoftTeams {
        return new NotificationMicrosoftTeams(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lagoon:lagoon:NotificationMicrosoftTeams';
     ...
     */
    public static isInstance(obj: any): obj is NotificationMicrosoftTeams {
