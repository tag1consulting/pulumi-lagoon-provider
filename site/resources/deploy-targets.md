...
| `token` | string | No | Access token for the cluster (secret) |
| `friendlyName` | string | No | Display name shown in the Lagoon UI |
...
production_cluster = lagoon.DeployTarget("production-cluster",
    lagoon.DeployTargetArgs(
        name="production",
        friendly_name="Production Cluster",
...
func main() {
    pulumi.Run(func(ctx *pulumi.Context) error {
        productionCluster, err := lagoon.NewDeployTarget(ctx, "production-cluster", &lagoon.DeployTargetArgs{
            ...
            FriendlyName:  pulumi.String("Production Cluster"),
            ConsoleUrl:    pulumi.String("https://api.k8s.production.example.com"),
            Token:         pulumi.String("<cluster-token-secret>"),
