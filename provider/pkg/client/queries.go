...
const mutationAddUserToGroup = `
mutation AddUserToGroup($input: UserGroupRoleInput!) {
...
const mutationRemoveUserFromGroup = `
mutation RemoveUserFromGroup($input: UserGroupInput!) {
...
const mutationAddPlatformRoleToUser = `
mutation AddPlatformRoleToUser($user: UserInput!, $role: PlatformRole!) {
    addPlatformRoleToUser(user: $user, role: $role) {
        id
        email
        platformRoles
    }
...
const mutationRemovePlatformRoleFromUser = `
mutation RemovePlatformRoleFromUser($user: UserInput!, $role: PlatformRole!) {
    removePlatformRoleFromUser(user: $user, role: $role) {
        id
        email
        platformRoles
    }
...
const queryUserByEmailWithGroupRoles = `
query UserByEmailWithGroupRoles($email: String!) {
    userByEmail(email: $email) {
        id
        email
        groupRoles {
...
const queryUserByEmailWithPlatformRoles = `
query UserByEmailWithPlatformRoles($email: String!) {
    userByEmail(email: $email) {
        id
        email
        platformRoles
