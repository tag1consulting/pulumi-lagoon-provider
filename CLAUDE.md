...
**Status**: v0.5.0 Released (Native Go Provider)
...
**Outputs:**
- `publicKey`: The SSH deploy key generated by Lagoon for the project (use this to add the deploy key to your Git repository)
