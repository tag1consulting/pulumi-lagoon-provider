...
class TestEnvironmentOperations:
    ...
    def test_add_environment_uppercase_enums(self, lagoon_client, mock_response, sample_environment):
...
class TestVariableOperations:
    ...
    def test_get_variable_by_name(self, lagoon_client, mock_response, sample_variable):
        ...
        response = mock_response(data={
            "envVariablesByProjectEnvironment": [sample_variable]
        })
        lagoon_client.session.post.return_value = response

        result = lagoon_client.get_env_variable_by_name(
            name="DATABASE_HOST",
            project=1
        )
    ...
    def test_delete_variable(self, lagoon_client, mock_response):
        ...
        result = lagoon_client.delete_env_variable(
            name="DATABASE_HOST",
            project=1
        )
